            ...
            <div class="container">
                ...
                <div class="Home_Cont_Right right">
                    ...
                    <div class="Home_Cont_Right_Top left">
                        ...
                        <div class="Top_Search2 right"><input id="tags1" name="" type="text" onclick="this.value='';"
                                onblur="validate_field('phone');" value="Type desired Job Location" /></div>
            ...
            <div class="container">
                <div class="filable_form_container">
                    <div class="form_container_block">
                        ...
                        ?>
                        <form class="post-form" action="update_products.php" method="post">
                            <ul>
                                <li class="fileds">
                                    <div class="name_fileds">
                                        <label>Product Name</label>
                                        <input type="hidden" name="pid" value="<?php echo $row['pid']; ?>" />
                                        <input name="firstname" type="text" value="<?php echo $row['pname']; ?>" />
                                    </div>
                                </li>
                                <li class="fileds">
                                    <div class="name_fileds">
                                        <label>Product Price</label>
                                        <input name="price" type="text" value="<?php echo $row['pprice']; ?>" />
                                    </div>
                                </li>
                                <li class="fileds">
                                    <div class="upload_fileds">
                                        <label>Upload Image</label>
                                        <input id="uploadFile" type="file" name="pimg" placeholder="Choose File"
                                    ...
                                    <div class="name_fileds">
                                        ...
                                        <?php
                                                ...
                                                if (mysqli_num_rows($result1) > 0) {
                                                    echo ' <select name="category" class="select category">';
                            ...
                            <div class="next_btn_block">
                                <div class="next_btn">
                                    <input id="save_btn" class="submit" type="submit" value="Submit" style=" background-color: #9fbc35;
    padding: 20px;
    color: #fff;
    width: 200px;
    display: block;
