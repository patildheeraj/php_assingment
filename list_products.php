                    ...
                    <div class="table_container_block">
                        <table width="100%">
                            <thead>
                                ...
                                $sql = "SELECT * FROM product JOIN category WHERE product.pcategory = category.cid";
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td style="text-align:center"><img
                                            src="http://www.weatherforecast.co.uk/blog/wp-content/uploads/2015/01/noimage.jpg"
                                    ...
                                    <td>
                                        <div class="buttons">
                                            ...
                                            <a class="btn btn_delete"
                                                href='edit_product.php?id=<?php echo $row['pid']; ?>'>Edit</a>
                                            <!-- <button class="btn btn_delete">Delete</button> -->
                                            <a class="btn btn_edit"
                                                href="delete-product-inline.php?id=<?php echo $row['pid']; ?>">Delete</a>
                                        </div>
                                    </td>
                                </tr>
                                <?php
